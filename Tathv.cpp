...
int main() {
  ...
  t1.join(); //tam dung chuong trinh lai và cho doi thread thuc hien xong.
  t2.join(); //tam dung chuong trinh lai và cho doi thread thuc hien xong.
  t3.join(); //tam dung chuong trinh lai và cho doi thread thuc hien xong.
  t4.join(); //tam dung chuong trinh lai và cho doi thread thuc hien xong.
}
